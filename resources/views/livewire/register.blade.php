        ...
        <div class="bg-slate-50 w-4/5 md:w-5/12 rounded-md">
            ...
            <div class="grid">
                <div class="relative w-full flex justify-center items-center">
                    <input wire:model="data.name" class="mb-5 w-10/12 bg-gray-50 text-gray-700 border rounded-lg py-3 px-4 focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="name" placeholder="Your Name">
                    @error('data.name')
                ...
                <div class="relative w-full flex justify-center items-center">
                    <input wire:model="data.username" class="mb-5 w-10/12 bg-gray-50 text-gray-700 border rounded-lg py-3 px-4 focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="username" placeholder="Your Username">
                    @error('data.username')
                    <small class="text-red-800 absolute text-[0.65rem] bottom-0.5">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="relative w-full flex justify-center items-center">
                    <input wire:model="data.password_confirmation" class="mb-5 w-10/12 bg-gray-50 text-gray-700 border rounded-lg py-3 px-4 focus:outline-none focus:bg-white focus:border-gray-500" type="password" name="password_confirmation" placeholder="Repeat your password">
